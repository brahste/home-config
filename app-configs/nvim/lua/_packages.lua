...
require('packer').startup(function()
    ...
    -- Buffer tab-styling at top of editor
    use {
        'romgrk/barbar.nvim',
    ...
    use {'hrsh7th/nvim-cmp', -- Variety of completion plugins
    'hrsh7th/cmp-nvim-lsp', 'hrsh7th/cmp-nvim-lua', 'hrsh7th/cmp-buffer', 'hrsh7th/cmp-path', 'hrsh7th/cmp-cmdline',
